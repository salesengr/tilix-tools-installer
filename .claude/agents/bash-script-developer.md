...
## Validation-Phase Guardrail (Current Branch)

On `recovery/tool-install-validation`, optimize for **small, additive changes** that unblock failing tools.
Avoid broad refactors or architecture changes until validation closure criteria are met.
