...
VERIFY[rustscan]="${HOME}/.cargo/bin/rustscan|rustscan --help 2>&1 | head -3"
VERIFY[feroxbuster]="${HOME}/.cargo/bin/feroxbuster|feroxbuster --help 2>&1 | head -3"
...
VERIFY[ripgrep]="${HOME}/.cargo/bin/rg|rg --version 2>&1 | head -2"
VERIFY[fd]="${HOME}/.cargo/bin/fd|fd --version 2>&1 | head -2"
VERIFY[bat]="${HOME}/.cargo/bin/bat|bat --version 2>&1 | head -2"
VERIFY[sd]="${HOME}/.cargo/bin/sd|sd --version 2>&1 | head -2"
VERIFY[dog]="${HOME}/.cargo/bin/dog|dog --version 2>&1 | head -2"
